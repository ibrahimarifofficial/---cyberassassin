    ...
    >
      ...
      <div className="container" style={{ position: 'relative', zIndex: 1, width: '100%' }}>
        <div style={{
          ...
          <div style={{
            ...
            <h1 className="hero-blog-title" style={{
              fontFamily: 'var(--font-heading)',
            ...
            <p style={{
              ...
              Stay ahead of cyber threats with expert insights, security strategies, and the latest trends in cybersecurity.
            </p>
            ...
            <div className="hero-breadcrumb" style={{
              ...
              <span style={{ color: '#ffffff', fontWeight: '400' }}>Blog</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <style jsx>{`
        ...
        @media (max-width: 768px) {
          ...
          .blog-hero > div > div:last-child > div:last-child {
            text-align: center !important;
          }
