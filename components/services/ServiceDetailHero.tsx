...
export default function ServiceDetailHero({ serviceName }: ServiceDetailHeroProps) {
  ...
  return (
    <section 
      ...
      role="region" 
      aria-label="Service Detail Hero section"
      style={{
        position: 'relative',
        minHeight: '80vh',
        display: 'flex',
    ...
    >
      ...
      <div className="container" style={{ position: 'relative', zIndex: 1, width: '100%' }}>
        <div style={{
          ...
          <div className="hero-vertical-text" style={{
          ...
          <div style={{
            ...
            <h1 className="hero-service-title" style={{
              fontFamily: 'var(--font-heading)',
            ...
            <p style={{
              ...
              Comprehensive AI-powered cybersecurity solutions designed to protect, detect, and respond to threats with precision and intelligence.
            </p>

            {/* Breadcrumb Navigation */}
            <div className="hero-breadcrumb" style={{
              display: 'flex',
              alignItems: 'center',
              gap: 'var(--spacing-sm)',
              ...
              <span style={{ color: '#ffffff', fontWeight: '400' }}>{serviceName}</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <style jsx>{`
        ...
        @media (max-width: 768px) {
          ...
          .service-detail-hero > div > div:last-child {
          ...
          .hero-vertical-text > div {
            display: none !important;
          }
          
          .service-detail-hero > div > div:last-child > div:last-child {
            text-align: center !important;
          }
        ...
        @media (max-width: 480px) {
          ...
          .service-detail-hero > div > div:last-child > div:last-child > div:first-child {
